...
//     // BrowserWindow.getFocusedWindow().setSize(BrowserWindow.getFocusedWindow().getSize()[0], document.querySelector('body').offsetHeight)
...
function disconnect()
{
    $('.devicePanel').fadeOut(500, () => 
    {
        $('.devicesList').fadeIn(500)
    })
}
